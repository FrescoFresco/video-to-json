...
for mid in expected:
    ...
    if mid in ("speech", "speakers", "on_screen_text", "objects_people", "faces_framing", "pose_actions", "visual_observation", "scene_cuts", "music_ambiance", "camera_motion", "audio_events", "ai_reasoning", "summary"):
        if not ok:
